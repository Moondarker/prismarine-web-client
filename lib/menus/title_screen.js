...
class TitleScreen extends LitElement {
  static get styles () {
    return css`
      ...
      .aVeryUniqueGame .minec {
        display: block;
        position: absolute;
        top: 0;
        left: 0;
        background-image: url('textures/1.17.1/gui/title/aVeryUniqueGame.png');
        background-size: 256px;
        width: 155px;
        height: 44px;
      }

      .aVeryUniqueGame .raft {
        display: block;
        position: absolute;
        top: 0;
        left: 155px;
  ...
  render () {
    return html`
      ...
      <div class="bottom-info">
        ...
        <span>A AVeryUniqueGame client in the browser!</span>
      </div>
    `
  }
}
